...
`),V(n,--this.indentLevel),n.push("}")),n.push(`,
`)}makeFunctionImport(e,t,i,n=null){var s=this.sb,a=i.signature;if(V(s,this.indentLevel),ke(t)?s.push(t):(s.push('"'),s.push(de(t,34)),s.push('"')),Gu(a,Lt.IMPORT)&&!n)s.push(`: (
...
`),Hh(n,1,p),p.push(`
})()`)):(e!="env"&&(p.push("__module"),p.push(c.toString()),p.push(".")),p.push(t),p.push("("),p.push(l.join(", ")),p.push(")")),n=p.join(""),p.length=0,Hh(n,this.indentLevel,p,!0),n=p.join(""),V(s,this.indentLevel),a.returnType!=u.void?(s.push("return "),this.makeLowerToValue(n,a.returnType,s),s.push(`;
`)):(s.push(n),s.push(`;
`)),V(s,--this.indentLevel),s.push("}")}s.push(`,
`)}visitFunction(e,t){if(!t.is(512)){var i=this.sb,n=t.signature;if(this.exports.push(e),!Gu(n,Lt.EXPORT)){V(i,this.indentLevel),i.push(e),i.push("(");let s=n.parameterTypes,a=0;for(let p=0,c=s.length;p<c;++p)s[p].isInternalReference&&a++,p>0&&i.push(", "),i.push(t.getParameterName(p));i.push(`) {
...
`);let o=s.length;for(let g=Map_keys(t),b=0,S=g.length;b<S;++b){let v=g[b],x=this.ensureModuleId(v),L=t.get(v);V(s,this.indentLevel),ke(v)?s.push(v):(s.push('"'),s.push(de(v,34)),s.push('"'));let P=s.length;s.push(": Object.assign(Object.create("),v=="env"?s.push("globalThis"):(s.push("__module"),s.push(x.toString())),s.push("), "),v=="env"&&s.push("imports.env || {}, "),s.push(`{
`),++this.indentLevel;let F=0;for(let w=Map_keys(L),U=0,Y=w.length;U<Y;++U){let z=w[U],H=assert(L.get(z));if(H.kind==5){let Q=H,le=this.getExternalCode(Q);(!Gu(Q.signature,Lt.IMPORT)||!ke(z)||le)&&(this.makeFunctionImport(v,z,H,le),++F)}else if(H.kind==0){let Q=H;(!Rr(Q.type,Lt.IMPORT)||!ke(z))&&(this.makeGlobalImport(v,z,Q),++F)}}--this.indentLevel,F?(V(s,this.indentLevel),s.push(`}),
`)):(s.length=P,v=="env"?s.push(": Object.assign(Object.create(globalThis), imports.env || {})"):(s.push(": __module"),s.push(x.toString())),s.push(`,
...
`)}if(this.needsLowerArray){let g=i.arrayBufferInstance.id,b=i.arrayBufferViewInstance,S=b.nextMemoryOffset+4,v=b.offsetof("buffer"),x=b.offsetof("dataStart"),L=b.offsetof("byteLength"),P=L+4;s.push(`  function __lowerArray(lowerElement, id, align, values) {
...
`);else{let P=this.ensureModuleId(L);V(s,2),ke(L)?s.push(L):(s.push('"'),s.push(de(L,34)),s.push('"')),s.push(": __maybeDefault(__import"),s.push(P.toString()),s.push(`),
`),b.push("import * as __import"),b.push(P.toString()),b.push(' from "'),b.push(de(L,34)),b.push(`";
...
`),V(t,--this.indentLevel),t.push(`}
`),t.join("")}},Lt=(t=>(t[t.IMPORT=0]="IMPORT",t[t.EXPORT=1]="EXPORT",t))(Lt||{});function Rr(r,e){if(e==0){if(r.isIntegerValue&&r.size==64||r==u.bool)return!1}else if(r.isUnsignedIntegerValue&&r.size==32||r==u.bool)return!1;return!r.isInternalReference}function Gu(r,e){var t=r.parameterTypes,i=e==0?1:0;for(let n=0,s=t.length;n<s;++n)if(!Rr(t[n],i))return!1;return!!Rr(r.returnType,e)}function Hh(r,e,t,i=!1){for(var n=0,s=r.length,a=0;a<s;)r.charCodeAt(a)==10&&(i?i=!1:V(t,e),t.push(r.substring(n,n=a+1))),++a;n<s&&(i||V(t,e),t.push(r.substring(n)))}var Nr=class extends Cn{constructor(e,t,i=!1){super(e,i);this.sb=[];this.indentLevel=0;this.seenObjectTypes=new Map;this.deferredTypings=new Array;this.esm=t}static build(e,t=!0){return new Nr(e,t).build()}visitGlobal(e,t){var i=this.sb,n=t.type,s=this.toTypeScriptType(n,hi.EXPORT);V(i,this.indentLevel),i.push("/** "),i.push(t.internalName),i.push(` */
...
`)}else t.push(`
`);V(t,this.indentLevel)}serializeParameter(e){var t=this.sb,i=e.parameterKind,n=e.implicitFieldDeclaration;n&&this.serializeAccessModifiers(n),i==2&&t.push("..."),this.visitIdentifierExpression(e.name);var s=e.type,a=e.initializer;s&&(i==1&&!a&&t.push("?"),xe(s)||(t.push(": "),this.visitTypeNode(s))),a&&(t.push(" = "),this.visitNode(a))}serializeExternalModifiers(e){var t=this.sb;e.is(2)?t.push("export "):e.is(1)?t.push("import "):e.is(4)&&t.push("declare ")}serializeAccessModifiers(e){var t=this.sb;e.is(4)&&t.push("declare "),e.is(256)?t.push("public "):e.is(512)?t.push("private "):e.is(1024)&&t.push("protected "),e.is(32)?t.push("static "):e.is(128)&&t.push("abstract "),e.is(64)&&t.push("readonly ")}finish(){var e=this.sb.join("");return this.sb=[],e}};var rV=Vu;export{Ks as ASTBuilder,ga as ArrayLiteralExpression,Ni as ArrowKind,Ta as AssertionExpression,Gr as AssertionKind,Cu as AtomicRMWOp,ba as BinaryExpression,Bu as BinaryModule,$r as BinaryOp,Qa as BlockStatement,Jc as BrOnOp,Za as BreakStatement,Ia as CallExpression,Ci as Class,Kn as ClassDeclaration,va as ClassExpression,xs as ClassPrototype,xa as CommaExpression,Ea as CommentKind,ya as CommentNode,Pe as CommonFlags,O as CommonNames,Ka as CompiledExpression,oi as Compiler,Ll as ConditionKind,Dl as ConstantValueKind,ql as Constraints,Sa as ConstructorExpression,ja as ContinueStatement,gS as DEFAULT_STACK_SIZE,We as DeclarationStatement,Gt as DeclaredElement,Z as DecoratorFlags,Et as DecoratorKind,da as DecoratorNode,Vn as DiagnosticCategory,tt as DiagnosticCode,ze as DiagnosticEmitter,Ri as DiagnosticMessage,Ja as DoStatement,Is as Element,Ra as ElementAccessExpression,J as ElementKind,$a as EmptyStatement,Ul as Enum,eo as EnumDeclaration,Bl as EnumValue,to as EnumValueDeclaration,so as ExportDefaultStatement,ro as ExportImportStatement,io as ExportMember,ln as ExportNames,no as ExportStatement,fe as Expression,nr as ExpressionId,Us as ExpressionRunnerFlags,ao as ExpressionStatement,Xl as ExternalKind,SS as FEATURE_BULK_MEMORY,NS as FEATURE_EXCEPTION_HANDLING,MS as FEATURE_EXTENDED_CONST,OS as FEATURE_FUNCTION_REFERENCES,kS as FEATURE_GC,PS as FEATURE_MEMORY64,FS as FEATURE_MULTI_VALUE,vS as FEATURE_MUTABLE_GLOBALS,xS as FEATURE_NONTRAPPING_F2I,CS as FEATURE_REFERENCE_TYPES,wS as FEATURE_RELAXED_SIMD,IS as FEATURE_SIGN_EXTENSION,RS as FEATURE_SIMD,LS as FEATURE_TAIL_CALLS,AS as FEATURE_THREADS,Ya as FalseExpression,Ot as Feature,jl as FeatureFlags,jn as Field,oo as FieldDeclaration,Nl as FieldFlags,Gl as FieldPrototype,Ts as File,Aa as FloatLiteralExpression,Ue as Flow,ds as FlowFlags,uo as ForOfStatement,lo as ForStatement,je as Function,Wr as FunctionDeclaration,Na as FunctionExpression,Xe as FunctionPrototype,fa as FunctionTypeNode,On as GETTER_PREFIX,ti as Global,Le as INDEX_SUFFIX,na as INNER_DELIMITER,vi as INSTANCE_DELIMITER,it as IdentifierExpression,No as IdentifierHandling,po as IfStatement,co as ImportDeclaration,Yn as ImportStatement,$n as IndexSignature,qa as IndexSignatureNode,La as InstanceOfExpression,Ca as IntegerLiteralExpression,es as Interface,_o as InterfaceDeclaration,Vl as InterfacePrototype,Ar as JSBuilder,Ze as LIBRARY_PREFIX,Mn as LIBRARY_SUBST,yt as LiteralExpression,we as LiteralKind,De as Local,Es as LocalFlags,un as MemorySegment,fo as MethodDeclaration,lt as Module,bo as ModuleDeclaration,Wn as NamedTypeNode,vs as Namespace,ho as NamespaceDeclaration,Fa as NewExpression,k as Node,dt as NodeKind,ka as NullExpression,Pa as ObjectLiteralExpression,Oa as OmittedExpression,Ce as OperatorKind,ws as Options,Zd as PARENT_SUBST,Qe as PATH_DELIMITER,Ac as Parameter,Br as ParameterKind,ma as ParameterNode,wa as ParenthesizedExpression,gs as Parser,he as Precedence,bs as Program,Jn as Property,Ma as PropertyAccessExpression,ri as PropertyPrototype,se as Range,jc as RefAsOp,Ms as RefIsOp,Ua as RegexpLiteralExpression,Ln as Relooper,Qn as ReportMode,Zn as Resolver,mo as ReturnStatement,Pn as Runtime,Ql as RuntimeFeatures,wn as SETTER_PREFIX,Fu as SIMDExtractOp,Ou as SIMDLoadOp,wu as SIMDLoadStoreLaneOp,ku as SIMDReplaceOp,Pu as SIMDShiftOp,Mu as SIMDTernaryOp,xi as STATIC_DELIMITER,sa as STUB_DELIMITER,pn as SideEffects,ve as Signature,zr as Source,Vr as SourceKind,Co as State,ue as Statement,Ba as StringLiteralExpression,Ga as SuperExpression,Ds as SwitchBuilder,Eo as SwitchCase,yo as SwitchStatement,Nr as TSDBuilder,Mr as Target,Va as TemplateLiteralExpression,Da as TernaryExpression,za as ThisExpression,go as ThrowStatement,Yr as Token,qn as Tokenizer,Wa as TrueExpression,To as TryStatement,u as Type,Io as TypeDeclaration,bt as TypeDefinition,wt as TypeFlags,ir as TypeKind,_a as TypeName,Hn as TypeNode,ha as TypeParameterNode,C as TypeRef,Vt as TypedElement,bi as Typeinfo,Ii as TypeinfoFlags,Xn as UnaryExpression,Ji as UnaryOp,Ha as UnaryPostfixExpression,Xa as UnaryPrefixExpression,vo as VariableDeclaration,Ai as VariableLikeDeclarationStatement,ur as VariableLikeElement,xo as VariableStatement,So as VoidStatement,Ro as WhileStatement,fS as addGlobalAlias,me as allocPtrArray,uR as buildJS,lR as buildTSD,oR as compile,Oe as createType,rV as default,ju as diagnosticCategoryToColor,Gn as diagnosticCategoryToString,Fn as diagnosticCodeToString,DS as disableFeature,US as enableFeature,Kl as expandType,wr as featureToString,gt as findDecorator,st as findUsedLocals,Ju as formatDiagnostic,Ju as formatDiagnosticMessage,Me as getBinaryLeft,Jr as getBinaryOp,Se as getBinaryRight,pR as getBinaryenModuleRef,rn as getBlockChildAt,tn as getBlockChildCount,en as getBlockName,N2 as getBreakCondition,A2 as getBreakName,Fe as getCallOperandAt,at as getCallOperandCount,ji as getCallTarget,Ye as getConstValueF32,He as getConstValueF64,ie as getConstValueI32,$e as getConstValueI64High,Be as getConstValueI64Low,Jl as getConstValueV128,Nc as getDefaultParameterName,sR as getDependee,XS as getDiagnosticCategory,HS as getDiagnosticCode,KS as getDiagnosticMessage,qS as getDiagnosticRange,QS as getDiagnosticRelatedRange,C2 as getDropValue,te as getExpressionId,oe as getExpressionType,P2 as getFunctionBody,O2 as getFunctionName,w2 as getFunctionParams,M2 as getFunctionResults,U2 as getFunctionVars,$i as getGlobalGetName,G2 as getGlobalInit,D2 as getGlobalName,B2 as getGlobalType,ms as getIfCondition,jr as getIfFalse,Zi as getIfTrue,Cl as getLoadBytes,g2 as getLoadOffset,T2 as getLoadPtr,ot as getLocalGetIndex,fs as getLocalSetIndex,lr as getLocalSetValue,R2 as getLoopBody,S2 as getLoopName,k2 as getMemoryGrowDelta,jS as getRangeEnd,JS as getRangeSource,ZS as getRangeStart,F2 as getReturnValue,L2 as getSelectCondition,Pl as getSelectElse,kl as getSelectThen,ai as getSideEffects,YS as getSource,$S as getSourceNormalizedPath,b2 as getStoreBytes,I2 as getStoreOffset,v2 as getStorePtr,x2 as getStoreValue,V2 as getTagName,z2 as getTagParams,W2 as getTagResults,Qi as getUnaryOp,hs as getUnaryValue,aR as initializeProgram,Je as isConstNonZero,ge as isConstZero,nn as isDeclaredElement,rR as isError,$l as isGlobalMutable,Lo as isIllegalVariableIdentifier,eR as isInfo,Fl as isLoadSigned,qi as isLocalTee,xe as isTypeOmitted,Fo as isTypedElement,tR as isWarning,Te as mangleInternalName,Li as mangleInternalPath,zs as mustPreserveSideEffects,Bs as needsExplicitUnreachable,$2 as newOptions,zS as newProgram,WS as nextDiagnostic,nR as nextFile,ye as operatorTokenToString,_R as optimize,iR as parse,Ve as readString,hS as removeGlobalAlias,GS as setBasenameHint,bS as setBundleVersion,iS as setExportMemory,yS as setExportRuntime,mS as setExportStart,uS as setExportTable,nS as setImportMemory,lS as setImportTable,sS as setInitialMemory,ES as setLowMemoryLimit,aS as setMaximumMemory,cS as setMemoryBase,rS as setNoAssert,dS as setNoUnsafe,BS as setOptimizeLevelHints,VS as setPedantic,tS as setRuntime,oS as setSharedMemory,pS as setSourceMap,TS as setStackSize,_S as setTableBase,eS as setTarget,$u as tokenFromKeyword,ep as tokenIsAlsoIdentifier,Dr as typesToRefs,zn as typesToString,ca as util,cR as validate};
